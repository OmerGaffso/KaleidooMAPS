    ...
    if (
      (!(function (e, t) {
        var r = !a,
          n = e.length;
        if (!r && 1 < n)
          for (var i = e[0].modelMatrix, o = 1; o < n; ++o)
            if (!P.Matrix4.equals(i, e[o].modelMatrix)) {
              r = !0;
              break;
            }
        if (r)
          for (o = 0; o < n; ++o)
            y.defined(e[o].geometry) &&
              b.GeometryPipeline.transformToWorldCoordinates(e[o]);
