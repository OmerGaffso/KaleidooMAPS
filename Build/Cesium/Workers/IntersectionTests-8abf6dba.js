define([
  ...
  var l = {
    ...
    p = new x.Cartesian3(),
    v = new x.Cartesian3();
  (l.rayTriangleParametric = function (a, t, e, r, n) {
    ...
    (l.rayTriangle = function (a, t, e, r, n, i) {
      n = l.rayTriangleParametric(a, t, e, r, n);
      if (d.defined(n) && !(n < 0))
        return (
  ...
  l.grazingAltitudeLocation = function (a, t) {
    var e = a.origin,
      r = a.direction;
  ...
  (l.lineSegmentPlane = function (a, t, e, r) {
    ...
    (l.trianglePlaneIntersection = function (a, t, e, r) {
      var n,
        i,
        s = r.normal,
        o = r.distance,
      ...
      if (
        ...
        if (u)
          return (
            l.lineSegmentPlane(a, t, r, n),
            l.lineSegmentPlane(a, e, r, i),
            { positions: [a, t, e, n, i], indices: [0, 3, 4, 1, 2, 4, 1, 4, 3] }
          );
        if (c)
          return (
            l.lineSegmentPlane(t, e, r, n),
            l.lineSegmentPlane(t, a, r, i),
            { positions: [a, t, e, n, i], indices: [1, 3, 4, 2, 0, 4, 2, 4, 3] }
          );
        if (s)
          return (
            l.lineSegmentPlane(e, a, r, n),
            l.lineSegmentPlane(e, t, r, i),
            { positions: [a, t, e, n, i], indices: [2, 3, 4, 0, 1, 4, 0, 4, 3] }
          );
      } else if (2 == o) {
        if (!u)
          return (
            l.lineSegmentPlane(t, a, r, n),
            l.lineSegmentPlane(e, a, r, i),
            { positions: [a, t, e, n, i], indices: [1, 2, 4, 1, 4, 3, 0, 3, 4] }
          );
        if (!c)
          return (
            l.lineSegmentPlane(e, t, r, n),
            l.lineSegmentPlane(a, t, r, i),
            { positions: [a, t, e, n, i], indices: [2, 0, 4, 2, 4, 3, 1, 3, 4] }
          );
        if (!s)
          return (
            l.lineSegmentPlane(a, e, r, n),
            l.lineSegmentPlane(t, e, r, i),
            { positions: [a, t, e, n, i], indices: [0, 1, 4, 0, 4, 3, 2, 3, 4] }
          );
      }
    }),
    (a.IntersectionTests = l),
    (a.Ray = e);
});
