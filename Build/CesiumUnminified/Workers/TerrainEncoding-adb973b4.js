...
define([
  ...
  function computeMagnitude(ellipsoid, position, scaledSpaceDirectionToPoint) {
    ...
    var magnitudeSquared = Cartesian2.Cartesian3.magnitudeSquared(
      scaledSpacePosition
    );
  ...
  function TerrainEncoding(
    ...
    if (
      ...
      var translation = Cartesian2.Cartesian3.negate(
        minimum,
        cartesian3Scratch
      );
  ...
  TerrainEncoding.prototype.getAttributes = function (buffer) {
    ...
    var sizeInBytes = ComponentDatatype.ComponentDatatype.getSizeInBytes(
      datatype
    );
    var stride;
