...
define([
  ...
  GroundPolylineGeometry.createGeometry = function (groundPolylineGeometry) {
    ...
    for (i = 1; i < cartographicsLength - 1; ++i) {
      previousBottom = Cartesian2.Cartesian3.clone(
        vertexBottom,
        previousBottom
      );
  ...
  function generateGeometryAttributes(
    ...
    for (i = 0; i < segmentCount; i++) {
      ...
      var startTop = Cartesian2.Cartesian3.clone(
        endTop,
    ...
    var boundingSphere = Transforms.BoundingSphere.fromBoundingSpheres(
      boundingSpheres
    );
    ...
    if (compute2dAttributes) {
      ...
      attributes.startEndNormals2D = getVec4GeometryAttribute(
        startEndNormals2D
      );
