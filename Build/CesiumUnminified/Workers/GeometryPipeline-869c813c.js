...
define([
  ...
  function barycentricCoordinates(point, p0, p1, p2, result) {
    ...
    if (!when.defined(p0.z)) {
      if (
        ...
        return Cartesian2.Cartesian3.clone(
  ...
  GeometryPipeline.reorderForPreVertexCache = function (geometry) {
    ...
    var numVertices = GeometryAttribute.Geometry.computeNumberOfVertices(
      geometry
    );
  ...
  GeometryPipeline.transformToWorldCoordinates = function (instance) {
    ...
    instance.modelMatrix = Transforms.Matrix4.clone(
      Transforms.Matrix4.IDENTITY
    );
    ...
    for (i = 0; i < numVertices; ++i) {
      ...
      if (hasNormal && when.defined(tangents) && when.defined(bitangents)) {
        ...
        if (hasNormal) {
          ...
          compressedAttributes[
            normalIndex++
          ] = AttributeCompression.AttributeCompression.octEncodeFloat(
            toEncode1
          );
        }
